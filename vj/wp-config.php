...
define('DB_NAME', 'viktoriajaderli');

/** MySQL-databasens användarnamn */
define('DB_USER', 'viktoriajaderli');

/** MySQL-databasens lösenord */
define('DB_PASSWORD', '8bTsimTW');

/** MySQL-server */
define('DB_HOST', 'viktoriajaderling.se.mysql');
 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'viktory');
define('SECURE_AUTH_KEY',  'viktory1');
define('LOGGED_IN_KEY',    'viktory11');
define('NONCE_KEY',        'viktory111');
define('AUTH_SALT',        'viktory1111');
define('SECURE_AUTH_SALT', 'viktory11111');
define('LOGGED_IN_SALT',   'viktory111111');
define('NONCE_SALT',       'viktory1111111');
